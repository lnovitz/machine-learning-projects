...
```{r,message=FALSE}
budget <- qplot(tmdb_enhanced$budget, geom="histogram")
popularity <- qplot(tmdb_enhanced$popularity, geom="histogram")
revenue <- qplot(tmdb_enhanced$revenue, geom="histogram")
runtime <- qplot(tmdb_enhanced$runtime, geom="histogram")
vote_average <- qplot(tmdb_enhanced$vote_average, geom="histogram")
vote_count <- qplot(tmdb_enhanced$vote_count, geom="histogram")
...
kable(
  tmdb_enhanced %>% 
    ...
    count(),
  align = c("l", "c"),
  caption = "Table 1: Distribution of genre"
)
```
